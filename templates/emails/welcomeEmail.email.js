                            ...
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%; text-align: center;"><span
                                    style="font-size: 28px;  color: #ffffff; font-family: Poppins, sans-serif; font-weight: bold;">Welcome to akses!</span></p>
                              </div>
                          ...
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 140%; text-align: justify;"><span
                                    style="font-size: 16px; line-height: 25.2px; color: #1c103b; ">Big shoutout for choosing akses! 🚀 Your spot is officially reserved. Time to rock your account – use those sign-up deets to dive in.</span></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                            ...
                            <td
                              ...
                              <div align="left">
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 16px; line-height: 25.2px; color: #1c103b;">Let's make it awesome! Cheers,</span></p>
                                <p style="font-size: 14px; line-height: 140%;"><span
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                        style="font-size: 16px; line-height: 22.4px;">Need a hand or just wanna chat? Holler at us:<br>akses@purnama.tech</span></em></span><br /><span
                                    style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
