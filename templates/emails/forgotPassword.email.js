                                                              ...
                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 30px;font-family:'Lato',sans-serif;"
                                                                  ...
                                                                  <table width="100%" cellpadding="0" cellspacing="0"
                                                                      ...
                                                                      <tr>
                                                                          <td style="padding-right: 0px;padding-left: 0px;"
                                                                              align="center">
                                                                              <a href="https://unlayer.com"
                                                                                  target="_blank">
                                                                                  <img align="center" border="0"
                                                                                      src="https://cdn.templates.unlayer.com/assets/1636432929697-file.png"
                                                                                      alt="Logo" title="Logo"
                                                                  ...
                                                                  <table width="100%" cellpadding="0" cellspacing="0"
                                                                      ...
                                                                      <tr>
                                                                          <td style="padding-right: 0px;padding-left: 0px;"
                                                                              ...
                                                                              <img align="center" border="0"
                                                                                  src="https://cdn.templates.unlayer.com/assets/1638247919624-uuu.jpg"
                                                              ...
                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 44px 8px;font-family:'Lato',sans-serif;"
                                                                  ...
                                                                  <div
                                                                      ...
                                                                      <p
                                                                          style="font-size: 14px; line-height: 190%; text-align: center;">
                                                                          <span
                                                                              style="font-size: 22px; line-height: 41.8px;"><strong>Token
                                                                                  Lupa Password Kamu: </strong></span>
                                                                      </p>
                                                                      <p
                                                                          style="font-size: 14px; line-height: 190%; text-align: center;">
                                                                          <span
                                                                              style="font-size: 22px; line-height: 41.8px;"><strong>${otp}</strong></span>
                                                                      </p>
                                                                      <p
                                                                          style="font-size: 14px; line-height: 190%; text-align: center;">
                                                                          </p>
                                                                      ...
                                                                      <p style="font-size: 14px; line-height: 190%; text-align: center" >
                                                                          Email ini dibuat otomatis pada ${new Date().toLocaleTimeString(
                                                                            "id-ID",
                                                                            {
                                                                              year: "numeric",
                                                                              month:
                                                          ...
                                                          <tr>
                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 20px;font-family:'Lato',sans-serif;"
                                                                  ...
                                                                  <div
                                                                      ...
                                                                      <p style="font-size: 14px; line-height: 190%;">If
                                                                          you have any questions, feel free message us
                                                                          at <span
